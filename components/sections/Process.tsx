...
const steps = [
  {
    number: "01",
    title: "Konzultacije",
    description: "Analiziramo vaše potrebe i zahtjeve projekta. Savjetujemo vas o optimalnim rješenjima i tehničkim specifikacijama.",
    icon: (
  ...
  {
    number: "02",
    title: "Ponuda i planiranje",
    description: "Izrađujemo detaljnu ponudu i tehničku dokumentaciju. Planiramo projekt uz koordinaciju s vašim timom.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    number: "03",
    title: "Proizvodnja",
    description: "Proizvodimo vrata prema specifikacijama uz stroge kontrole kvalitete. Svi proizvodi prolaze testiranje.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Certificirani tehničari ugrađuju vrata prema standardima. Predajemo projekt s kompletnom dokumentacijom.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">

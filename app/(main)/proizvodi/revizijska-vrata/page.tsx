...
export default function InspectionDoorsPage() {
  return (
    <>
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
            <Reveal className="lg:col-span-7">
              <p className={eyebrow}>List P—05 / Revizijska vrata</p>
              <h1
      ...
      <SectionRule code="P—P / 05" />

      {/* Zašto revizijska vrata */}
      <section className="py-20 lg:py-28">
        <Container>
              ...
              <figure>
                <div className={`relative aspect-square overflow-hidden border ${hairline}`}>
                  <Image
                    ...
                    alt="Revizijska protupožarna vrata"
                    fill
                ...
                <figcaption
                  className={`${mono} mt-3 text-[10px] uppercase leading-relaxed tracking-[0.2em] text-gray`}
                >
                  Revizijska vrata / pristup instalacijama
                </figcaption>
              </figure>
            </Reveal>

            <Reveal className="order-1 lg:order-2">
              <p className={eyebrow}>Obrazloženje / Revizija</p>
              <h2
                className={`${display} mt-4 text-4xl font-semibold uppercase leading-none md:text-5xl`}
              >
